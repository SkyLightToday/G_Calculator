...
import java.util.HashMap;//это класс в Java коллекции интерфейсов и классов позволяет хранить пары ключей и значений (key & value)
//Номерных индексов, как в массивах или списках, в HashMap нет — доступ к значению осуществляется по ключу.
import java.util.Map;//Map данные хранятся в формате “ключ”-”значение”
...
public class Parse {
    ...
    //проверяем, что это арабское число
    ...
    //проверяем, что это римское число
    public boolean isRoman(String str) {
        return romeArabMap.containsKey(str);
    }

    //из римского в арабское число (ограничение I..X)
    ...
    //из арабского в римское число (ограничение 1..399)
